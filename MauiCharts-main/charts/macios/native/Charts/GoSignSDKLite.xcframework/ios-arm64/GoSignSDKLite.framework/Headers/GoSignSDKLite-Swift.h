...
+ (void)setTimeDisableBiometric:(NSInteger)time;
+ (NSInteger)getTimeDisableBiometric SWIFT_WARN_UNUSED_RESULT;
...
@class AuthoriseaListPendingAPIResponse;

@interface API (SWIFT_EXTENSION(GoSignSDKLite))
+ (void)registerDeviceWithToken:(NSString * _Nonnull)authenToken localizedReason:(NSString * _Nonnull)localizedReason localizedFallbackTitle:(NSString * _Nonnull)localizedFallbackTitle localizedCancelTitle:(NSString * _Nonnull)localizedCancelTitle completion:(void (^ _Nonnull)(RegisterDeviceAPIResponse * _Nullable, ServerResponseError * _Nullable))completion;
+ (void)authoriseaPendingRequestWithToken:(NSString * _Nonnull)authenToken localizedReason:(NSString * _Nonnull)localizedReason localizedFallbackTitle:(NSString * _Nonnull)localizedFallbackTitle localizedCancelTitle:(NSString * _Nonnull)localizedCancelTitle pendingAuthorisationAPIResponse:(PendingAuthorisationAPIResponse * _Nonnull)pendingAuthorisationAPIResponse completion:(void (^ _Nonnull)(ServerResponseError * _Nullable))completion;
+ (void)authoriseaPendingRequestListWithToken:(NSString * _Nonnull)authenToken localizedReason:(NSString * _Nonnull)localizedReason localizedFallbackTitle:(NSString * _Nonnull)localizedFallbackTitle localizedCancelTitle:(NSString * _Nonnull)localizedCancelTitle pendingAuthorisation:(NSArray<PendingAuthorisationAPIResponse *> * _Nonnull)pendingAuthorisation completion:(void (^ _Nonnull)(AuthoriseaListPendingAPIResponse * _Nullable, ServerResponseError * _Nullable))completion;
@end
